...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "music-podcast:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmusic_podcast"] = self["webpackChunkmusic_podcast"] || [];
...
;// CONCATENATED MODULE: ./src/router/paths.ts
var Paths;
(function (Paths) {
    Paths["Home"] = "/";
    Paths["PodcastDetails"] = "/podcast/:podcastId";
    Paths["EpisodeDetails"] = "/podcast/:podcastId/episode/:episodeId";
})(Paths || (Paths = {}));
/* harmony default export */ var paths = (Paths);
...
;// CONCATENATED MODULE: ./node_modules/cache-parser/dist/index.mjs
...
var targetUrl = 'https://itunes.apple.com/us/rss/toppodcasts/limit=100/genre=1310/json';
var get_podcasts_endpoint_axios = $(lib_axios);
var getPodcastsEndpoint = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, get_podcasts_endpoint_axios.get(proxyUrl + targetUrl, {
...
var mapPodcast = function (input) {
    ...
    return {
        ...
        name: (_a = input["im:name"]) === null || _a === void 0 ? void 0 : _a.label,
        image: input["im:image"],
        summary: (_b = input.summary) === null || _b === void 0 ? void 0 : _b.label,
        rights: (_c = input.rights) === null || _c === void 0 ? void 0 : _c.label,
        title: input.title.label,
        artist: (_d = input["im:artist"]) === null || _d === void 0 ? void 0 : _d.label
    };
};
...
;// CONCATENATED MODULE: ./src/podcast/mapper/index.ts


;// CONCATENATED MODULE: ./src/podcast/service/get-podcasts.ts
var get_podcasts_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var get_podcasts_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var getPodcastsFromItunes = function () { return get_podcasts_awaiter(void 0, void 0, void 0, function () {
    var err_1;
    return get_podcasts_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, getPodcastsEndpoint().then(function (data) {
...
var getSinglePodcast = function (podcastId) { return get_podcasts_awaiter(void 0, void 0, void 0, function () {
    ...
    return get_podcasts_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                allPodcasts = getPodcastsFromItunes();
                return [4 /*yield*/, allPodcasts];
            case 1:
                requiredPodcast = (_a.sent()).podcast.filter(function (filteredPodcast) { return filteredPodcast.id === podcastId; });
                return [2 /*return*/, requiredPodcast];
        }
    });
}); };

;// CONCATENATED MODULE: ./src/podcast/service/index.ts


;// CONCATENATED MODULE: ./src/podcast/use-case/get-podcasts.ts
...
;// CONCATENATED MODULE: ./src/episode/component/episode-list/episode-list-item.tsx
var episode_list_item_assign = (undefined && undefined.__assign) || function () {
    episode_list_item_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return episode_list_item_assign.apply(this, arguments);
};



var EpisodeListItem = function (_a) {
    var episode = _a.episode;
    var name = episode.name, releaseDate = episode.releaseDate, trackTimeMillis = episode.trackTimeMillis;
    var episodeUrl = "/podcast/".concat(episode.collectionId, "/episode/").concat(episode.id);
    ...
    var parsedTimeMillis = function () {
        var timeInSeconds = trackTimeMillis / 1000;
        var hours = Math.floor(timeInSeconds / 3600);
        var minutes = Math.floor((timeInSeconds - hours * 3600) / 60);
        var seconds = Math.floor(timeInSeconds - hours * 3600 - minutes * 60).toFixed();
        var hoursString = hours < 1 ? '' : hours.toString().padStart(2, '0') + ':';
        var timeString = hoursString + minutes.toString().padStart(2, '0') + ':' + seconds.toString().padStart(2, '0');
        return timeString;
    };
    return ((0,jsx_runtime.jsxs)("div", episode_list_item_assign({ className: "episodeItemContainer" }, { children: [(0,jsx_runtime.jsx)(Link, episode_list_item_assign({ to: episodeUrl, className: "episodeTitle" }, { children: name })), (0,jsx_runtime.jsxs)("div", episode_list_item_assign({ className: "dataContainer" }, { children: [(0,jsx_runtime.jsx)("span", { children: parsedDate() }), (0,jsx_runtime.jsx)("span", { children: parsedTimeMillis() })] }))] })));
};
/* harmony default export */ var episode_list_item = (EpisodeListItem);

;// CONCATENATED MODULE: ./src/episode/component/episode-list/episode-list.tsx
var episode_list_assign = (undefined && undefined.__assign) || function () {
    episode_list_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return episode_list_assign.apply(this, arguments);
};



var EpisodeList = function (_a) {
    var episodes = _a.episodes;
    return ((0,jsx_runtime.jsxs)("div", episode_list_assign({ className: "episodeListContainer" }, { children: [(0,jsx_runtime.jsxs)("span", episode_list_assign({ className: "episodesNumber" }, { children: ["Episodes: ", episodes.length] })), (0,jsx_runtime.jsxs)("div", episode_list_assign({ className: "episodeListData" }, { children: [(0,jsx_runtime.jsxs)("div", episode_list_assign({ className: "episodeItemContainer" }, { children: [(0,jsx_runtime.jsx)("strong", episode_list_assign({ className: "episodeListTitle" }, { children: "Title" })), (0,jsx_runtime.jsxs)("div", episode_list_assign({ className: "dataContainer" }, { children: [(0,jsx_runtime.jsx)("strong", { children: "Date" }), (0,jsx_runtime.jsx)("strong", { children: "Duration" })] }))] })), episodes.map(function (episode) { return (0,jsx_runtime.jsx)(episode_list_item, { episode: episode }, episode.id); })] }))] })));
};
/* harmony default export */ var episode_list = (EpisodeList);

;// CONCATENATED MODULE: ./src/episode/component/episode-list/index.ts




;// CONCATENATED MODULE: ./src/episode/endpoint/get-episodes-endpoint.ts
var get_episodes_endpoint_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var get_episodes_endpoint_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var getEpisodesEndpoint = function (id) { return get_episodes_endpoint_awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return get_episodes_endpoint_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, lib_axios.get("https://itunes.apple.com/lookup?id=".concat(id, "&media=podcast&entity=podcastEpisode"), {
                        headers: { 'Content-Type': 'application/json' },
                    })];
            case 1:
                response = _a.sent();
...
;// CONCATENATED MODULE: ./src/episode/mapper/mapEpisodeFromItunes.ts
var mapEpisodeFromItunes_assign = (undefined && undefined.__assign) || function () {
    mapEpisodeFromItunes_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return mapEpisodeFromItunes_assign.apply(this, arguments);
};
var mapEpisode = function (input) {
    return {
        id: input.trackId,
...
var mapEpisodes = function (episodes) {
    return episodes.map(mapEpisode).map(function (episode, index) {
        return mapEpisodeFromItunes_assign(mapEpisodeFromItunes_assign({}, episode), { index: index });
    });
};
var mapEpisodesResults = function (input) {
    return mapEpisodes(input.results);
};

;// CONCATENATED MODULE: ./src/episode/mapper/index.ts


;// CONCATENATED MODULE: ./src/episode/service/get-episodes.ts
var get_episodes_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var get_episodes_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var getEpisodesFromItunes = function (podcastId) { return get_episodes_awaiter(void 0, void 0, void 0, function () {
    var err_1;
    return get_episodes_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, getEpisodesEndpoint(podcastId).then(function (data) {
...
;// CONCATENATED MODULE: ./src/episode/use-case/get-episodes.ts
...
var podcast_card_assign = (undefined && undefined.__assign) || function () {
    podcast_card_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return podcast_card_assign.apply(this, arguments);
};
...
;// CONCATENATED MODULE: ./src/podcast/component/podcast-card/index.ts


;// CONCATENATED MODULE: ./src/pages/podcast-details/podcast-details.tsx
var podcast_details_assign = (undefined && undefined.__assign) || function () {
    podcast_details_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return podcast_details_assign.apply(this, arguments);
};
...
var episode_details_assign = (undefined && undefined.__assign) || function () {
    episode_details_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
...
;// CONCATENATED MODULE: ./src/pages/episode-details/index.ts


;// CONCATENATED MODULE: ./src/router/router.tsx
...
var router_Router = function () {
    return ((0,jsx_runtime.jsx)(BrowserRouter, { children: (0,jsx_runtime.jsxs)(Routes, { children: [(0,jsx_runtime.jsx)(Route, { path: paths.Home, element: (0,jsx_runtime.jsx)(home, {}) }), (0,jsx_runtime.jsx)(Route, { path: paths.PodcastDetails, element: (0,jsx_runtime.jsx)(podcast_details, {}) }), (0,jsx_runtime.jsx)(Route, { path: paths.EpisodeDetails, element: (0,jsx_runtime.jsx)(episode_details, {}) }), (0,jsx_runtime.jsx)(Route, { path: "*", element: (0,jsx_runtime.jsx)("div", { children: "404" }) })] }) }));
};
...
function App() {
    return ((0,jsx_runtime.jsx)(router, {}));
}
